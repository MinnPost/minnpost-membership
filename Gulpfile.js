...
gulp.task( 'postcss', [ 'clean:styles' ], () =>
	gulp.src( 'assets/sass/*.scss', paths.css )
		...
		// Create minnpost-membership-admin.css.
...
gulp.task( 'cssnano', [ 'postcss' ], () =>
	gulp.src( 'assets/css/minnpost-membership-admin.css' )
		.pipe( plumber( {'errorHandler': handleErrors} ) )
		.pipe( cssnano( {
...
gulp.task( 'concat-admin', () =>
	gulp.src( paths.concat_scripts_admin )
		...
		.pipe( concat( 'minnpost-membership-admin.js' ) )

		// Append the sourcemap to minnpost-membership-admin.js.
		.pipe( sourcemaps.write() )

		// Save minnpost-membership-admin.js
 ...
 */
gulp.task( 'clean:pot', () =>
	del( [ 'languages/minnpost-membership.pot' ] )
);
...
gulp.task( 'wp-pot', [ 'clean:pot' ], () =>
	gulp.src( paths.php )
		...
		.pipe( sort() )
		.pipe( wpPot( {
			'domain': 'minnpost-membership',
			'package': 'minnpost-membership',
		} ) )
		.pipe( gulp.dest( 'languages/minnpost-membership.pot' ) )
);
